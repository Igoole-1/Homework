...
Console.WriteLine("Введите число координаты x1 ");
int x1 = Convert.ToInt32(Console.ReadLine());

Console.WriteLine("Введите число координаты y1 ");
int y1 = Convert.ToInt32(Console.ReadLine());

Console.WriteLine("Введите число координаты z1 ");
int z1 = Convert.ToInt32(Console.ReadLine());

Console.WriteLine("Введите число координаты x2 ");
int x2 = Convert.ToInt32(Console.ReadLine());

Console.WriteLine("Введите число координаты y2 ");
int y2 = Convert.ToInt32(Console.ReadLine());

Console.WriteLine("Введите число координаты z2 ");
